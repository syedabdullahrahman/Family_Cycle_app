 ...
 * {@link QueryFragment_af.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link QueryFragment_af#newInstance} factory method to
 * create an instance of this fragment.
 */
public class QueryFragment_af extends Fragment {
     ...
     * @return A new instance of fragment QueryFragment_af.
     */
    // TODO: Rename and change types and number of parameters
    public static QueryFragment_af newInstance(String param1, String param2) {
        QueryFragment_af fragment = new QueryFragment_af();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_query_fragment_af, container, false);
        ...
        JsonArrayRequest jsonObjectRequest = new JsonArrayRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        MyAdapter adapter = new MyAdapter(getActivity(), noteTitle, noteDescription);
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnFragmentInteractionListener) {
            ...
            Toast.makeText(context,"User Query fragment",Toast.LENGTH_SHORT).show();
        }
    }
