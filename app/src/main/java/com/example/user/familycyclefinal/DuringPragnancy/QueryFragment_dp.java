 ...
 * {@link QueryFragment_dp.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link QueryFragment_dp#newInstance} factory method to
 * create an instance of this fragment.
 */
public class QueryFragment_dp extends Fragment {
     ...
     * @return A new instance of fragment QueryFragment_dp.
     */
    // TODO: Rename and change types and number of parameters
    public static QueryFragment_dp newInstance(String param1, String param2) {
        QueryFragment_dp fragment = new QueryFragment_dp();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_query_fragment_dp, container, false);
        ...
        JsonArrayRequest jsonObjectRequest = new JsonArrayRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        QueryFragment_dp.MyAdapter adapter = new QueryFragment_dp.MyAdapter(getActivity(), noteTitle, noteDescription);
